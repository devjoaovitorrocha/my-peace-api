...
export async function connectToDatabase () {
    ...
    const client: mongoDB.MongoClient = new mongoDB.MongoClient("mongodb+srv://admin:mypeace123@mypeace.9ibtalu.mongodb.net/?retryWrites=true&w=majority&appName=MyPeace");
